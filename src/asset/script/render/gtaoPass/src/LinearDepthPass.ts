import { BackSide, FrontSide, ShaderLib } from "three/src/Three";
...
export class LinearDepthPass extends ShaderReplacement {
    ...
    public updateUniforms(object: THREE.Object3D<Event>, material: THREE.Material, target: THREE.ShaderMaterial): void {
