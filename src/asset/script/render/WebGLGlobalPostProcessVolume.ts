...
export class WebGLGlobalPostProcessVolume extends Component {
    ...
    public onDisable(): void {
        ...
        if (effectComposer !== null) {
            this.removeAndDisposePasses(effectComposer, passes);
            this._passes = [];
    ...
    private initializeEffectComposer(effectComposer: EffectComposer, oldPasses: readonly Pass[], newPasses: readonly Pass[]): void {
        let startIndex = -1;
