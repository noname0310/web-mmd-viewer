export class BlueNoiseSamples {
    ...
    public lookupTable: Float32Array|null;
    public score: Float32Array|null;
    public binaryPattern: Uint8Array|null;
    ...
    public updateScore(x: number, y: number, multiplier: number): void {
    ...
    public addPointIndex(index: number): void {
    ...
    public removePointIndex(index: number): void {
    ...
    public copy(source: BlueNoiseSamples): void {
