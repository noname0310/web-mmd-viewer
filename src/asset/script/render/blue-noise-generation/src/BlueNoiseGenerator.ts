...
import { fillWithOnes, shuffleArray } from "./utils.js";

export class BlueNoiseGenerator {
    public random: () => number;
    public sigma: number;
    public size: number;
    public majorityPointsRatio: number;
    public samples: BlueNoiseSamples;
    public savedSamples: BlueNoiseSamples;
    ...
    public generate(): { data: Uint32Array; maxValue: number; } {
